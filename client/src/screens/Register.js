...
export default function Register() {
    ...
    const components = [
        (<>
            ...
            <p>Here is an useful <a target="_blank" rel="noreferrer" href="https://blog.pods.finance/guide-connecting-mumbai-testnet-to-your-metamask-87978071aca8">guide</a></p>
        </>),
        (<>
